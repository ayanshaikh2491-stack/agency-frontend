          ...
          <div className="relative flex shrink-0 items-center justify-between gap-2 px-4 py-3 border-b border-[var(--border)]">
            ...
            <div className="flex items-center gap-2">
              <button onClick={function() {
                window.location.href = 'https://www.facebook.com/v18.0/dialog/oauth?client_id=1900581880622376&redirect_uri=http%3A%2F%2F18.213.66.136%3A8000%2Fapi%2Fsocial%2Foauth%2Ffacebook%2Fcallback&scope=pages_show_list,pages_read_engagement,pages_manage_posts,instagram_basic,instagram_content_publish,public_profile&state=default:facebook&response_type=code';
              }}
